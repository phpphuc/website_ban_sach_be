...
class ElectronicBookProductBuilder implements ProductBuilderInterface
{
    ...
    public function file_format(string $file_format): self {
        $this->product->file_format = $file_format;
        return $this;
    }
    ...
    // {
    //     $this->product->save();
    //     $this->product->authors()->attach($this->product->author_ids);
    //     return $this->product;
    // }
}
